	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230401/18da3753d22a4199b5abc44dee037d48.png) fixed"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="试卷名称" prop="shijuanmingcheng">
					<el-input v-model="ruleForm.shijuanmingcheng" placeholder="试卷名称" clearable  :readonly="ro.shijuanmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="试卷名称" prop="shijuanmingcheng">
					<el-input v-model="ruleForm.shijuanmingcheng" placeholder="试卷名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="科目" prop="kemu">
					<el-input v-model="ruleForm.kemu" placeholder="科目" clearable  :readonly="ro.kemu"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="科目" prop="kemu">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="成绩" prop="chengji">
					<el-input v-model="ruleForm.chengji" placeholder="成绩" clearable  :readonly="ro.chengji"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="成绩" prop="chengji">
