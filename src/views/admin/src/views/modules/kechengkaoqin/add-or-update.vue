	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230401/18da3753d22a4199b5abc44dee037d48.png) fixed"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="打卡类型" prop="dakaleixing">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="打卡类型" prop="dakaleixing">
