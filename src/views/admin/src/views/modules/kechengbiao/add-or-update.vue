<template>
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230401/18da3753d22a4199b5abc44dee037d48.png) fixed"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="学年学期" prop="xuenianxueqi">
					<el-input v-model="ruleForm.xuenianxueqi" placeholder="学年学期" clearable  :readonly="ro.xuenianxueqi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="学年学期" prop="xuenianxueqi">
					<el-input v-model="ruleForm.xuenianxueqi" placeholder="学年学期" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="授课教师" prop="shoukejiaoshi">
					<el-input v-model="ruleForm.shoukejiaoshi" placeholder="授课教师" clearable  :readonly="ro.shoukejiaoshi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="授课教师" prop="shoukejiaoshi">
					<el-input v-model="ruleForm.shoukejiaoshi" placeholder="授课教师" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="课程号" prop="kechenghao">
					<el-input v-model="ruleForm.kechenghao" placeholder="课程号" clearable  :readonly="ro.kechenghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="课程号" prop="kechenghao">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="课表类型" prop="kebiaoleixing">
					<el-select :disabled="ro.kebiaoleixing" v-model="ruleForm.kebiaoleixing" placeholder="请选择课表类型" >
						<el-option
							v-for="(item,index) in kebiaoleixingOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="课表类型" prop="kebiaoleixing">
					<el-input v-model="ruleForm.kebiaoleixing"
						placeholder="课表类型" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="周次" prop="zhouci">
					<el-input v-model="ruleForm.zhouci" placeholder="周次" clearable  :readonly="ro.zhouci"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="周次" prop="zhouci">
					<el-input v-model="ruleForm.zhouci" placeholder="周次" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="节次" prop="jieci">
					<el-input v-model="ruleForm.jieci" placeholder="节次" clearable  :readonly="ro.jieci"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="节次" prop="jieci">
					<el-input v-model="ruleForm.jieci" placeholder="节次" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="搜课地点" prop="soukedidian">
					<el-input v-model="ruleForm.soukedidian" placeholder="搜课地点" clearable  :readonly="ro.soukedidian"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="搜课地点" prop="soukedidian">
					<el-input v-model="ruleForm.soukedidian" placeholder="搜课地点" readonly></el-input>
				</el-form-item>
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						if(o=='xuenianxueqi'){
							this.ruleForm.xuenianxueqi = obj[o];
							this.ro.xuenianxueqi = true;
							continue;
						}
						if(o=='shoukejiaoshi'){
						...
						if(o=='soukedidian'){
							this.ruleForm.soukedidian = obj[o];
							this.ro.soukedidian = true;
							continue;
						}
						if(o=='xuehao'){
